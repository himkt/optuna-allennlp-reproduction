...
CONFIG_PATH = os.path.join(EXAMPLE_DIR, "classifier_gpu.jsonnet")
MODEL_DIR = "gpu"
BEST_CONFIG_PATH = "gpu/best_classifier.json"
...
if __name__ == "__main__":
    ...
    with open("./gpu/BEST_TRIAL", "w") as o:
        print(study.best_trial.trial_id, file=o)
